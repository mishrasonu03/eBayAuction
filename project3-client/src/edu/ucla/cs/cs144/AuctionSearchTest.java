...
public class AuctionSearchTest {
	...
	throws AxisFault {
		...
		SearchResult[] basicResults = AuctionSearchClient.basicSearch(query, 0, 70);
		...
		/*
                ...
                SearchResult[] spatialResults = AuctionSearchClient.spatialSearch("cameras", region, 0, 10000);
